    ...
    public class SeedData
    {
        public static void Initialise(ApplicationDbContext applicationDbContext)
        {
               ...
               && !applicationDbContext.ConfigItems.Any())
            {
                ...
                demoModelConfig.ConfigItems.Add(new ConfigItem { PropertyName = "OptionHorizontal", Label = "OptionHorizontal", Order = 6, ConfigContainer = demoModelContainer1, Component = "Headway.Razor.Controls.Components.Option.OptionHorizontal, Headway.Razor.Controls", Tooltip = "RadioArgs", ComponentArgs = "Name=one;Value=Option 1|Name=two;Value=Option 2|Name=three;Value=Option 3" });
