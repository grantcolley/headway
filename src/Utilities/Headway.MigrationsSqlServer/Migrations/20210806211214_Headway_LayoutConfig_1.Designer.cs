...
namespace Headway.MigrationsSqlServer.Migrations
{
    ...
    [Migration("20210806211214_Headway_LayoutConfig_1")]
    partial class Headway_LayoutConfig_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Headway.Core.Model.ConfigItem", b =>
                {
                    ...
                    b.Property<int?>("LayoutConfigItemsLayoutConfigItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LayoutConfigItemsLayoutConfigItemId");

                    b.ToTable("ConfigItems");
                });

            modelBuilder.Entity("Headway.Core.Model.LayoutConfig", b =>
                {
                    b.Property<int>("LayoutConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Headway.Core.Model.LayoutConfigItem", b =>
                {
                    b.Property<int>("LayoutConfigItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("LayoutConfigItemId1")
                        .HasColumnType("int");
                    ...
                    b.HasKey("LayoutConfigItemId");

                    b.HasIndex("LayoutConfigId");

                    b.HasIndex("LayoutConfigItemId1");

                    b.ToTable("LayoutConfigItems");
                });
            ...
            modelBuilder.Entity("Headway.Core.Model.Config", b =>
                {
                    b.HasOne("Headway.Core.Model.LayoutConfig", "LayoutConfig")
                        .WithMany()
            ...
            modelBuilder.Entity("Headway.Core.Model.ConfigItem", b =>
                {
                    ...
                    b.HasOne("Headway.Core.Model.LayoutConfigItem", "LayoutConfigItems")
                        .WithMany()
                        .HasForeignKey("LayoutConfigItemsLayoutConfigItemId");

                    b.Navigation("LayoutConfigItems");
                });

            modelBuilder.Entity("Headway.Core.Model.LayoutConfigItem", b =>
                {
                    b.HasOne("Headway.Core.Model.LayoutConfig", null)
                        .WithMany("LayoutConfigItems")
                        .HasForeignKey("LayoutConfigId");

                    b.HasOne("Headway.Core.Model.LayoutConfigItem", null)
                        .WithMany("LayoutConfigItems")
                        .HasForeignKey("LayoutConfigItemId1");
                });
