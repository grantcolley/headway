...
namespace Headway.SeedData
{
    public class CoreData
    {
        ...
        private static void ConfigSearchItemConfig()
        {
            ...
            configSearchItemConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Component", Label = "Component", Order = 5, ConfigContainer = configSearchItemConfigContainer, Component = "Headway.Razor.Controls.Components.Dropdown, Headway.Razor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={nameof(SearchComponentOptionItems)}" });
            configSearchItemConfig.ConfigItems.Add(new ConfigItem { PropertyName = "ComponentArgs", Label = "ComponentArgs", Order = 6, ConfigContainer = configSearchItemConfigContainer, Component = "Headway.Razor.Controls.Components.TextMultiline, Headway.Razor.Controls", ComponentArgs = $"Name={Args.TEXT_MULTILINE_ROWS};Value=3" });
