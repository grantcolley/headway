...
namespace Headway.Core.Dynamic
{
    ...
    public static class DynamicTypeHelper
    {
        ...
        public static DynamicTypeHelper<T> Get<T>()
        {
            var t = typeof(T);
        ...
        /// <returns>An instance of a <see cref="DynamicTypeHelper"/> for the specified type.</returns>
        public static DynamicTypeHelper<T> Get<T>(IEnumerable<PropertyInfo> propertyInfos)
        {
            var t = typeof(T);
        ...
        private static DynamicTypeHelper<T> CreateTypeHelper<T>(IEnumerable<PropertyInfo> propertyInfos)
        {
        ...
        private static Func<T> CreateInstance<T>()
        {
            var t = typeof(T);
