...
namespace Headway.Core.Interface
{
    ...
    {
        Task<IResponse<IEnumerable<string>>> GetOptionTextItemsAsync(List<Arg> args);
        Task<IResponse<IEnumerable<string>>> GetOptionTextItemsAsync(List<DynamicArg> dynamicArgs);
