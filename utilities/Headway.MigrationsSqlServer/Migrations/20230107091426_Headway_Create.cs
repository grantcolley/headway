        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfigureStatesDuringBootstrap = table.Column<bool>(type: "bit", nullable: false),
                    ActionConfigurationClass = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Permissions = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowHistory", x => x.FlowHistoryId);
                    table.ForeignKey(
                        name: "FK_FlowHistory_Flows_FlowId",
                        column: x => x.FlowId,
