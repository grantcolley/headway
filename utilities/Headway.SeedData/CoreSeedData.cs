...
namespace Headway.SeedData
{
    public class CoreSeedData
    {
        ...
        private static void FlowConfig()
        {
            ...
            flowConfig.ConfigItems.Add(new ConfigItem { PropertyName = "States", Label = "States", Order = 6, ConfigContainer = statesContainer, Component = "Headway.Blazor.Controls.Components.GenericField, Headway.Blazor.Controls", ConfigName = "State", ComponentArgs = $"Name={Args.LIST_CONFIG};Value=StatesListDetail|Name={Args.PROPAGATE_FIELDS};Value=States" });
        ...
        private static void StateConfig()
        {
            ...
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "ParentStateCode", Label = "Parent State Code", Order = 4, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownText, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={nameof(DynamicArgStatesOptionTextItems)}|Name={Args.LINK_SOURCE};Value=States|Name={Args.IS_LOCAL_DYNAMICARG_OPTION};Value={Args.TRUE}" });
            ...
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "SubStateCodes", Label = "Sub State Codes", Order = 10, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownTextMultiSelect, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={nameof(DynamicArgStatesOptionTextItems)}|Name={Args.LINK_SOURCE};Value=States|Name={Args.IS_LOCAL_DYNAMICARG_OPTION};Value={Args.TRUE}" });
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "TransitionStateCodes", Label = "Transition State Codes", Order = 11, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownTextMultiSelect, Headway.Blazor.Controls", ComponentArgs=$"Name={Options.OPTIONS_CODE};Value={nameof(DynamicArgStatesOptionTextItems)}|Name={Args.LINK_SOURCE};Value=States|Name={Args.IS_LOCAL_DYNAMICARG_OPTION};Value={Args.TRUE}" });
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "RegressionStateCodes", Label = "Regression State Codes", Order = 12, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownTextMultiSelect, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={nameof(DynamicArgStatesOptionTextItems)}|Name={Args.LINK_SOURCE};Value=States|Name={Args.IS_LOCAL_DYNAMICARG_OPTION};Value={Args.TRUE}" });
            ...
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "ContextProperties", Label = "Context Properties", Order = 15, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownTextMultiSelect, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={nameof(ModelFieldsOptionTextItems)}|Name={Args.LINK_SOURCE};Value=ContextFullName" });
