...
namespace Headway.SeedData
{
    public class CoreSeedData
    {
        ...
        private static void StateConfig()
        {
            ...
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "SubStateCodes", Label = "Sub State Codes", Order = 10, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownMultiSelect, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={nameof(DynamicArgStatesOptionTextItems)}|Name={Args.LINK_SOURCE};Value=States|Name={Args.IS_LOCAL_DYNAMICARG_OPTION};Value={Args.TRUE}" });
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "TransitionStateCodes", Label = "Transition State Codes", Order = 11, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownMultiSelect, Headway.Blazor.Controls", ComponentArgs=$"Name={Options.OPTIONS_CODE};Value={nameof(DynamicArgStatesOptionTextItems)}|Name={Args.LINK_SOURCE};Value=States|Name={Args.IS_LOCAL_DYNAMICARG_OPTION};Value={Args.TRUE}" });
            stateConfig.ConfigItems.Add(new ConfigItem { PropertyName = "RegressionStateCodes", Label = "Regression State Codes", Order = 12, ConfigContainer = stateConfigContainer, Component = "Headway.Blazor.Controls.Components.DropdownMultiSelect, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={nameof(DynamicArgStatesOptionTextItems)}|Name={Args.LINK_SOURCE};Value=States|Name={Args.IS_LOCAL_DYNAMICARG_OPTION};Value={Args.TRUE}" });
