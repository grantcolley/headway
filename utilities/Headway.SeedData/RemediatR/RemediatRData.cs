...
namespace Headway.SeedData.RemediatR
{
    public class RemediatRData
    {
        ...
        public static Config RedressConfigCreate()
        {
            ...
            var redressDetailsContainer = new ConfigContainer { Name = "Redress Create Div", Code = "REDRESS CREATE DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REDRESS_CREATE, Order = 1, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REDRESS_CREATE_CODE}" };
            var refundAssessmentContainer = new ConfigContainer { Name = "Refund Assessment Div", Code = "REFUND ASSESSMENT DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_ASSESSMENT, Order = 2, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_ASSESSMENT_CODE}" };

            var refundCalculationContainer = new ConfigContainer { Name = "Refund Calculation Div", Code = "REFUND CALCULATION DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_CALCULATION, Order = 1, ParentCode = "REFUND ASSESSMENT DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_CALCULATION_CODE}" };
            var refundVerificationContainer = new ConfigContainer { Name = "Refund Verification Div", Code = "REFUND VERIFICATION DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_VERIFICATION, Order = 2, ParentCode = "REFUND ASSESSMENT DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_VERIFICATION_CODE}" };

            var refundReviewContainer = new ConfigContainer { Name = "Refund Review Div", Code = "REFUND REVIEW DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_REVIEW, Order = 3, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_REVIEW_CODE}" };
            var redressReviewContainer = new ConfigContainer { Name = "Redress Review Div", Code = "REDRESS REVIEW DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REDRESS_REVIEW, Order = 4, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.FINAL_REDRESS_REVIEW_CODE}" };

            var redressValidationContainer = new ConfigContainer { Name = "Redress Validation Div", Code = "REDRESS VALIDATION DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REDRESS_VALIDATION, Order = 4, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REDRESS_VALIDATION_CODE}" };
            var communicationGenerationContainer = new ConfigContainer { Name = "Communication Generation Div", Code = "COMMUNICATION GENERATION DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.COMMUNICATION_GENERATION, Order = 5, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.COMMUNICATION_GENERATION_CODE}" };
            var communicationDispatchContainer = new ConfigContainer { Name = "Communication Dispatch Div", Code = "COMMUNICATION DISPATCH DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.COMMUNICATION_DISPATCH, Order = 6, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.COMMUNICATION_DISPATCH_CODE}" };
            var responseRequiredContainer = new ConfigContainer { Name = "Response Required Div", Code = "RESPONSE REQUIRED DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.RESPONSE_REQUIRED, Order = 7, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.RESPONSE_REQUIRED_CODE}" };

            var awaitingResponseContainer = new ConfigContainer { Name = "Awaiting Response Div", Code = "AWAITING RESPONSE DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.AWAITING_RESPONSE, Order = 8, ParentCode = "RESPONSE REQUIRED DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.AWAITING_RESPONSE_CODE}" };

            var paymentGenerationContainer = new ConfigContainer { Name = "Payment Generation Div", Code = "PAYMENT GENERATION DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.PAYMENT_GENERATION, Order = 9, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.PAYMENT_GENERATION_CODE}" };
            var finalRedressReviewContainer = new ConfigContainer { Name = "Final Redress Review Div", Code = "FINAL REDRESS REVIEW DIV", Container = "Headway.Blazor.Controls.Containers.Div, Headway.Blazor.Controls", Label = RemediatRFlowCodes.FINAL_REDRESS_REVIEW, Order = 10, ParentCode = "REDRESS DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.FINAL_REDRESS_REVIEW_CODE}" };
