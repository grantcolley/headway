...
namespace Headway.SeedData.RemediatR
{
    public class RemediatRData
    {
        ...
        public static Config RedressCustomerConfigCreate()
        {
            ...
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "CustomerId", Label = "Customer Id", IsIdentity = true, Order = 1, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Label, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Title", Label = "Title", Order = 2, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Dropdown, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={Options.STATIC_OPTION_ITEMS}|Name=Ms;Value=Ms|Name=Mr;Value=Mr|Name=Mrs;Value=Mrs|Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "FirstName", Label = "FirstName", Order = 3, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Surname", Label = "Surname", IsTitle = true, Order = 4, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            ...
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Telephone", Label = "Telephone", Order = 6, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Email", Label = "Email", Order = 7, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "SortCode", Label = "Sort Code", Order = 8, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "AccountNumber", Label = "Account Number", Order = 9, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Address1", Label = "Address1", Order = 10, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Address2", Label = "Address2", Order = 11, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Address3", Label = "Address3", Order = 12, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Address4", Label = "Address4", Order = 13, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Address5", Label = "Address5", Order = 14, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Country", Label = "Country", Order = 15, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Dropdown, Headway.Blazor.Controls", ComponentArgs = $"Name={Options.OPTIONS_CODE};Value={Options.COUNTRY_OPTION_ITEMS}|Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressCustomerConfig.ConfigItems.Add(new ConfigItem { PropertyName = "PostCode", Label = "PostCode", Order = 16, ConfigContainer = redressCustomerConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
        ...
        public static Config RedressProductConfigCreate()
        {
            ...
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "ProductId", Label = "Product Id", IsIdentity = true, Order = 1, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.Label, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Name", Label = "Name", IsTitle = true, Order = 2, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.Text, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Value", Label = "Value", Order = 3, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.DecimalNullable, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.FORMAT};Value={Args.FORMAT_F2}|Name={Args.MAX};Value=9999999999999.99|Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Rate", Label = "Rate", Order = 4, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.DecimalNullable, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.FORMAT};Value={Args.FORMAT_F2}|Name={Args.MAX_LENGTH};Value=5|Name={Args.MAX};Value=99.99|Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "Duration", Label = "Duration", Order = 5, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.IntegerNullable, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.MIN};Value=3|Name={Args.MAX};Value=360|Name={Args.READ_ONLY};Value={Args.TRUE}", Tooltip = "Duration must be min 3 and max 360" });
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "StartDate", Label = "Start Date", Order = 6, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.DateNullable, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.READ_ONLY};Value={Args.TRUE}" });
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "ProductType", Label = "ProductType", Order = 7, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.GenericDropdown, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.COMPONENT};Value=Headway.Blazor.Controls.Components.DropdownEnum`1, Headway.Blazor.Controls|Name={Args.MODEL};Value=RemediatR.Core.Enums.ProductType, RemediatR.Core|Name={Args.READ_ONLY};Value={Args.TRUE}" });
            ...
            redressProductConfig.ConfigItems.Add(new ConfigItem { PropertyName = "RepaymentType", Label = "RepaymentType", Order = 9, ConfigContainer = redressProductConfigContainer, Component = "Headway.Blazor.Controls.Components.GenericDropdown, Headway.Blazor.Controls", ComponentArgs = $"Name={Args.COMPONENT};Value=Headway.Blazor.Controls.Components.DropdownEnum`1, Headway.Blazor.Controls|Name={Args.MODEL};Value=RemediatR.Core.Enums.RepaymentType, RemediatR.Core|Name={Args.READ_ONLY};Value={Args.TRUE}" });
        ...
        public static Config RedressConfigCreate()
        {
            ...
            var redressConfigContainer = new ConfigContainer { Name = "Redress Container", Code = "REDRESS CONTAINER", Container = "Headway.Blazor.Controls.Flow.Containers.FlowListContainer`1, Headway.Blazor.Controls", Label = "Redress Details", Order = 1, ComponentArgs = $"Name={FlowConstants.FLOW_LIST_CONTAINER_LABEL};Value=Redress Flow|Name={FlowConstants.FLOW_LIST_CONTAINER_WIDTH};Value=400px", FlowArgs = $"Name={FlowConstants.FLOW_CODE};Value={RemediatRFlowCodes.REMEDIATR_CODE}" };

            var redressDetailsContainer = new ConfigContainer { Name = "Redress Create Flow Div", Code = "REDRESS CREATE FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REDRESS_CREATE, Order = 1, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REDRESS_CREATE_CODE}" };
            var refundAssessmentContainer = new ConfigContainer { Name = "Refund Assessment Flow Div", Code = "REFUND ASSESSMENT FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_ASSESSMENT, Order = 2, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_ASSESSMENT_CODE}" };

            var refundCalculationContainer = new ConfigContainer { Name = "Refund Calculation Flow Div", Code = "REFUND CALCULATION FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_CALCULATION, Order = 1, ParentCode = "REFUND ASSESSMENT FLOW DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_CALCULATION_CODE}" };
            var refundVerificationContainer = new ConfigContainer { Name = "Refund Verification Flow Div", Code = "REFUND VERIFICATION FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_VERIFICATION, Order = 2, ParentCode = "REFUND ASSESSMENT FLOW DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_VERIFICATION_CODE}" };

            var refundReviewContainer = new ConfigContainer { Name = "Refund Review Flow Div", Code = "REFUND REVIEW FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REFUND_REVIEW, Order = 3, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REFUND_REVIEW_CODE}" };
            var redressReviewContainer = new ConfigContainer { Name = "Redress Review Flow Div", Code = "REDRESS REVIEW FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REDRESS_REVIEW, Order = 4, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.FINAL_REDRESS_REVIEW_CODE}" };

            var redressValidationContainer = new ConfigContainer { Name = "Redress Validation Flow Div", Code = "REDRESS VALIDATION FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.REDRESS_VALIDATION, Order = 4, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.REDRESS_VALIDATION_CODE}" };
            var communicationGenerationContainer = new ConfigContainer { Name = "Communication Generation Flow Div", Code = "COMMUNICATION GENERATION FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.COMMUNICATION_GENERATION, Order = 5, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.COMMUNICATION_GENERATION_CODE}" };
            var communicationDispatchContainer = new ConfigContainer { Name = "Communication Dispatch Flow Div", Code = "COMMUNICATION DISPATCH FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.COMMUNICATION_DISPATCH, Order = 6, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.COMMUNICATION_DISPATCH_CODE}" };
            var responseRequiredContainer = new ConfigContainer { Name = "Response Required Flow Div", Code = "RESPONSE REQUIRED FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.RESPONSE_REQUIRED, Order = 7, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.RESPONSE_REQUIRED_CODE}" };

            var awaitingResponseContainer = new ConfigContainer { Name = "Awaiting Response Flow Div", Code = "AWAITING RESPONSE FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.AWAITING_RESPONSE, Order = 8, ParentCode = "RESPONSE REQUIRED FLOW DIV", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.AWAITING_RESPONSE_CODE}" };

            var paymentGenerationContainer = new ConfigContainer { Name = "Payment Generation Flow Div", Code = "PAYMENT GENERATION FLOW DIV", Container = "Headway.Blazor.Controls.Containers.Flow.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.PAYMENT_GENERATION, Order = 9, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.PAYMENT_GENERATION_CODE}" };
            var finalRedressReviewContainer = new ConfigContainer { Name = "Final Redress Review Flow Div", Code = "FINAL REDRESS REVIEW FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = RemediatRFlowCodes.FINAL_REDRESS_REVIEW, Order = 10, ParentCode = "REDRESS CONTAINER", FlowArgs = $"Name={FlowConstants.FLOW_STATE_CODE};Value={RemediatRFlowCodes.FINAL_REDRESS_REVIEW_CODE}" };

            var redressCustomerConfigContainer = new ConfigContainer { Name = "Redress Customer Tab Flow Div", Code = "REDRESS CUSTOMER TAB FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = "Customer", Order = 2 };
            var redressProductConfigContainer = new ConfigContainer { Name = "Redress Product Tab Flow Div", Code = "REDRESS PRODUCT TAB FLOW DIV", Container = "Headway.Blazor.Controls.Flow.Containers.FlowDiv, Headway.Blazor.Controls", Label = "Product", Order = 3 };
